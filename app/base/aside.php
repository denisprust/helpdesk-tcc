    ...
    <div class="aside-inner">
        <nav class="sidebar" data-sidebar-anyclick-close="">
            ...
            <ul class="sidebar-nav">
                    ...
                    <div class="collapse" id="user-block">
                        <div class="item user-block">
                            ...
                            <div class="user-block-info">
                                <span class="user-block-name">Olá, Denis</span>
                                <span class="user-block-role">Desenvolvedor</span>
                            </div>
                        </div>
                    </div>
                </li><!-- END user info-->
                <!-- Iterates over all sidebar items-->
                <li class="nav-heading ">Menu de navegação</li>
                <li class=" ">
                ...
                <li class="">
                    <a href="usuarios.php" title="Usuários">
                        <em class="fa fa-users"></em>
                        <span>Usuários</span>
                    </a>
                </li>
                <li class="">
                    <a href="horas.php" title="Horas">
