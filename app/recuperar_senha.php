    ...
    <div class="wrapper d-flex">
        <div class="block-center wd-xl justify-content-center align-self-center">
         ...
         <div class="card card-flat shadow-sm">
            ...
            <div class="card-body">
               <p class="text-center py-2 text-bold">Recuperação de senha</p>
               <form>
...
<!--                      <label class="text-muted" for="resetInputEmail1">Endereço de e-mail</label>-->
                     <div class="input-group with-focus"><input class="form-control border-right-0" id="resetInputEmail1" type="email" placeholder="E-mail" autocomplete="off">
