      ...
      <div class="block-center wd-xl justify-content-center align-self-center">
         ...
         <div class="card card-flat">
            <div class="card-header text-center bg-dark">
                <a href="#">
                    <h4 class="block-center rounded text-white">
...
<!--               <p class="text-center py-2">SIGN IN TO CONTINUE.</p>-->
               <form class="mb-3" id="loginForm" action="dashboard.php" novalidate>
                  <div class="form-group">
                     <div class="input-group with-focus">
                        <input class="form-control border-right-0" id="exampleInputEmail1" type="email" placeholder="E-mail" autocomplete="off" required>
                  ...
                  <div class="form-group">
                     <div class="input-group with-focus">
                        <input class="form-control border-right-0" id="exampleInputPassword1" type="password" placeholder="Senha" required>
                        <div class="input-group-append">
                            <span class="input-group-text text-muted bg-transparent border-left-0">
